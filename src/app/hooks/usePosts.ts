...
const compareBoolean = (valueA: boolean | null | undefined, valueB: boolean | null | undefined): number => {
...
const compareDates = (valueA: DateType | null | undefined, valueB: DateType | null | undefined): number => {
